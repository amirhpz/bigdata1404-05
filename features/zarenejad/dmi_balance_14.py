...
from feature_utils import add_feature_per_symbol, dmi_balance

FEATURE_COL = "dmi_balance_14_scaled_signed_m1_p1"
...
def main() -> None:
    p = argparse.ArgumentParser(description="Compute dmi_balance_14 (Class B).")
